...
$(SERVER_TARGET): $(SERVER_SRC)
	$(CC) -w -c -o mathserver/object/kmeans.o mathserver/include/kmeans.c 
	$(CC) -w -c -o mathserver/object/matrix_inverse.o mathserver/include/matrix_inverse.c
	$(CC) -w -I$(INCLUDE_PATH) -O2 -o $@ $^ mathserver/object/kmeans.o mathserver/object/matrix_inverse.o
